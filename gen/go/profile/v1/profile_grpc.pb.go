...
const (
	...
	ProfileService_GetByUsername_FullMethodName = "/profile.v1.ProfileService/GetByUsername"
...
type ProfileServiceClient interface {
	...
	GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*UserProfile, error)
...
func (c *profileServiceClient) GetByUsername(ctx context.Context, in *GetByUsernameRequest, opts ...grpc.CallOption) (*UserProfile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserProfile)
...
type ProfileServiceServer interface {
	...
	GetByUsername(context.Context, *GetByUsernameRequest) (*UserProfile, error)
...
func (UnimplementedProfileServiceServer) GetByUsername(context.Context, *GetByUsernameRequest) (*UserProfile, error) {
...
func _ProfileService_GetByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).GetByUsername(ctx, req.(*GetByUsernameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
